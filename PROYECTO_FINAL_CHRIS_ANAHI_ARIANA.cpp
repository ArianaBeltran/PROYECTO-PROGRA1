...
void ReporteEgresos(string archivoGastosmensuales)
{
    ...
    } else 
    {
        ...
        while (mcops.read((char*)&gastos, sizeof (gastos)))
        {
            ...
            cout << "Pago de salario a conserjes :(EGRESO FIJO que solo se llena una vez por mes) : " << gastos.gastosalarios << endl;
           cout << " =============================================================================================================" << endl;
           encontrado = true;
        } 
    }
...
void reporteGeneral (string archivoCop, string archivoGastosmensuales)
{
    ...
    cout<< "-------------------------------------------------- INGRESOS ---------------------------------" << endl;
    cout << " Se presentan todos los cobros de mantenimiento ====================================" << endl;
    PagosdetodosCop(archivoCop);
    cout << "---------------------------------------------------EGRESOS --------------------------------------------------------"<< endl;
    ReporteEgresos(archivoGastosmensuales);
    cout << endl; 
    cout << " ----------------------------------------------------SALDO POR MES -----------------------------------------------------"<< endl;
    cout << " \t RECUERDA : El saldo es la cantidad de dinero disponible en una cuenta o registro financiero después de sumar los ingresos y restar los egresos (gastos o retiros)."<< endl;
    cout << endl; 
     ...
     while (mcops.read((char*)&gastos, sizeof (gastos)))
        {
            for (int i = 0 ; i< 12 ; i++)
            {
                cout << " --------------------------------------------------------------------" << endl; 
                cout << " \t MES    : " << i << endl;
                cout << " \t INGRESO \t  EGRESO "<< endl;
                cout << "\t "<<montoXmes(i,archivoCop)<< " \t " << gastos.totalGasto[i]<< endl;
                cout << "SALDO : " << montoXmes(i,archivoCop) - gastos.totalGasto[i] <<  " bs. "<< endl; 
                total = total + (montoXmes(i,archivoCop) - gastos.totalGasto[i]);
            }
            
        }
         mcops.close();
         cout << "\t\t\t POR EL MOMENTO , SE REGISTRARON : " << total << " BOLIVIANOS \n \t Al final de anio se sumara a la RESERVA GENERAL del edificio . " << endl; 
    }
